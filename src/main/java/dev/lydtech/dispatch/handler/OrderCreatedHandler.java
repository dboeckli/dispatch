...
public class OrderCreatedHandler {
    ...
    @KafkaListener(id = "orderConsumerClient", topics = ORDER_CREATED_TOPIC, groupId = ORDER_CREATED_TOPIC_GROUP_ID)
    public void listen(@Header(KafkaHeaders.RECEIVED_PARTITION) Integer partition,
            @Header(KafkaHeaders.RECEIVED_KEY) String key, @Payload OrderCreated orderCreated) {
